...
win32:!exists($$OUT_PWD/$$VARIANT/Binaries) { mkpath($$OUT_PWD/$$VARIANT/Binaries) }
unix:!exists($$OUT_PWD/Binaries) { mkpath($$OUT_PWD/Binaries) }

win32:!exists($$OUT_PWD/$$VARIANT/ControllerFiles) { mkpath($$OUT_PWD/$$VARIANT/ControllerFiles) }
unix:!exists($$OUT_PWD/ControllerFiles) { mkpath($$OUT_PWD/ControllerFiles) }

win32:!exists($$OUT_PWD/$$VARIANT/ControllerFiles/ParameterFiles) { mkpath($$OUT_PWD/$$VARIANT/ControllerFiles/ParameterFiles) }
unix:!exists($$OUT_PWD/ControllerFiles/ParameterFiles) { mkpath($$OUT_PWD/ControllerFiles/ParameterFiles) }

win32:!exists($$OUT_PWD/$$VARIANT/StructuralFiles) { mkpath($$OUT_PWD/$$VARIANT/StructuralFiles) }
unix:!exists($$OUT_PWD/StructuralFiles) { mkpath($$OUT_PWD/StructuralFiles) }
