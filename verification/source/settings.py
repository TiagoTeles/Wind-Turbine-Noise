...
BEM_DTU_PATH = "verification/data/aerodynamics/DTU.csv"     # DTU verification path
...
CAA_NREL_PATH = "verification/data/aeroacoustics/NREL.csv"  # NREL verification path
CAA_TNO_PATH = "verification/data/aeroacoustics/TNO.csv"    # TNO verification path
