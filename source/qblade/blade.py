...
class Blade():
    ...
    Attributes:
        ...
        offset_y : np.ndarray -- offset in the y-direction, [m]
        offset_x : np.ndarray -- offset in the x-direction, [m]
        pitch_axis_y : np.ndarray -- pitch axis position the in y-direction, [-]
        pitch_axis_x : np.ndarray -- pitch axis position the in x-direction, [-]
